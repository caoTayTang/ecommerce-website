...
?>
    ...
    <div id="user" onclick="location.href='/admin/user.php'" style="
    background-image: url('/admin/employees/photos/<?php echo $anh_dai_dien ?>');
    background-size:30px;
    background-position: 15px 20px;
    background-repeat: no-repeat;">
    </div>
        <div id="shopping_cart" onclick="alert('Bạn là admin!')"></div>
